...
async function signup(req, res, next) {
   ...
   if (!validation.userDetailsAreValid(req.body.email, req.body.password, req.body.fullname, req.body.street, req.body.postal, req.body.city) ||
      ...
      sessionFlash.flashDataToSession(req, {
         errorMessage: 'Please check your input. Password must be at least 6 character long, postal code must be at least 5 characters long.',
         ...enteredData
      }, function () {
         res.redirect('/signup');
      });
   ...
   try {
      const userExists = await user.existsAlready();
      if (userExists) {
         sessionFlash.flashDataToSession(req, {
